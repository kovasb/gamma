...
return (function (){
if(cljs.core.truth_((function (){var and__3939__auto__ = clojure.browser.repl.load_queue;
if(cljs.core.truth_(and__3939__auto__)){
...
var script__$1 = (function (){var G__7389 = script;
(G__7389["type"] = "text/javascript");

(G__7389["onload"] = onload);

(G__7389["onreadystatechange"] = onload);

return G__7389;
})();
var script__$2 = (((opt_sourceText == null))?(function (){var G__7390 = script__$1;
(G__7390["src"] = src);

return G__7390;
})():(function (){var G__7391 = script__$1;
goog.dom.setTextContext(G__7391,opt_sourceText);
...
var reload_QMARK_ = (function (){var or__3951__auto__ = reload;
...
var path_7392 = (goog.dependencies_.nameToPath[src]);
delete goog.dependencies_.visited[path_7392];

delete goog.dependencies_.written[[cljs.core.str(goog.basePath),cljs.core.str(path_7392)].join('')];
} else {
}
