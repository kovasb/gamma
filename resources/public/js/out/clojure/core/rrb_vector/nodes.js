...
var slc = (rngs[(32)]);
var and__3939__auto__ = (slc === (32));
if(and__3939__auto__){
var or__3951__auto__ = (shift === (5));
if(or__3951__auto__){
return or__3951__auto__;
} else {
var G__7241 = (root.arr[(slc - (1))]);
var G__7242 = (shift - (5));
var G__7243 = (((rngs[(31)]) - (rngs[(30)])) + (32));
root = G__7241;
shift = G__7242;
cnt = G__7243;
continue;
...
var rngs_7252 = clojure.core.rrb_vector.nodes.ranges.call(null,parent);
var rng0_7253 = (rngs_7252[(0)]);
var new_rngs_7254 = [null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null];
var lim_7255 = (rngs_7252[(32)]);
cljs.core.array_copy.call(null,rngs_7252,(1),new_rngs_7254,(0),(lim_7255 - (1)));

var i_7256 = (0);
while(true){
if((i_7256 < lim_7255)){
(new_rngs_7254[i_7256] = ((new_rngs_7254[i_7256]) - rng0_7253));
...
(new_rngs_7254[(32)] = ((rngs_7252[(32)]) - (1)));

(new_rngs_7254[((rngs_7252[(32)]) - (1))] = (0));

(new_arr[(32)] = new_rngs_7254);
} else {
}
...
while(true){
if((i_7258 <= li)){
(new_rngs[i_7258] = ((new_rngs[(i_7258 - (1))]) + step));
...
var G__7264 = (j_7262 + (1));
var G__7265 = (r_7263 + step);
j_7262 = G__7264;
r_7263 = G__7265;
continue;
} else {
...
var rngs = ((!(reg_QMARK_))?(function (){var G__7267 = [null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null];
(G__7267[(0)] = node.arr.length);
...
var arr_7268__$1 = arr;
var shift_7269__$1 = shift;
while(true){
if((shift_7269__$1 === (5))){
if(!(reg_QMARK_)){
(arr_7268__$1[(32)] = rngs);
} else {
}

(arr_7268__$1[(0)] = node);
} else {
var a_7270 = (new Array(len));
var e_7271 = cljs.core.__GT_VectorNode.call(null,null,a_7270);
(arr_7268__$1[(0)] = e_7271);
...
var G__7272 = a_7270;
var G__7273 = (shift_7269__$1 - (5));
arr_7268__$1 = G__7272;
shift_7269__$1 = G__7273;
continue;
}
break;
}
...
var reg_QMARK_ = (function (){var and__3939__auto__ = clojure.core.rrb_vector.nodes.regular_QMARK_.call(null,node);
