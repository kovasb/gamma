...
var or__3951__auto__ = cljs.test._STAR_current_env_STAR_;
...
return cljs.test.update_current_env_BANG_.cljs$core$IFn$_invoke$arity$variadic((arguments[(0)]),(arguments[(1)]),argseq__4991__auto__);
});
...
cljs.test.update_current_env_BANG_.cljs$lang$applyTo = (function (seq6813){
...
return cljs.test.update_current_env_BANG_.cljs$core$IFn$_invoke$arity$variadic(G__6814,G__6815,seq6813__$2);
});
...
var map__6818 = m;
var map__6818__$1 = ((cljs.core.seq_QMARK_.call(null,map__6818))?cljs.core.apply.call(null,cljs.core.hash_map,map__6818):map__6818);
var column = cljs.core.get.call(null,map__6818__$1,new cljs.core.Keyword(null,"column","column",2078222095));
var line = cljs.core.get.call(null,map__6818__$1,new cljs.core.Keyword(null,"line","line",212345235));
var file = cljs.core.get.call(null,map__6818__$1,new cljs.core.Keyword(null,"file","file",-1269645878));
return [cljs.core.str(cljs.core.reverse.call(null,cljs.core.map.call(null,((function (map__6818,map__6818__$1,column,line,file){
return (function (p1__6816_SHARP_){
return new cljs.core.Keyword(null,"name","name",1843675177).cljs$core$IFn$_invoke$arity$1(cljs.core.meta.call(null,p1__6816_SHARP_));
});})(map__6818,map__6818__$1,column,line,file))
 ...
 */
cljs.test.report = (function (){var method_table__4846__auto__ = cljs.core.atom.call(null,cljs.core.PersistentArrayMap.EMPTY);
...
return (new cljs.core.MultiFn(cljs.core.symbol.call(null,"cljs.test","report"),((function (method_table__4846__auto__,prefer_table__4847__auto__,method_cache__4848__auto__,cached_hierarchy__4849__auto__,hierarchy__4850__auto__){
return (function (m){
...
});})(method_table__4846__auto__,prefer_table__4847__auto__,method_cache__4848__auto__,cached_hierarchy__4849__auto__,hierarchy__4850__auto__))
,new cljs.core.Keyword(null,"default","default",-1987822328),hierarchy__4850__auto__,method_table__4846__auto__,prefer_table__4847__auto__,method_cache__4848__auto__,cached_hierarchy__4849__auto__));
})();
}
...
var temp__4126__auto___6819 = new cljs.core.Keyword(null,"message","message",-406056002).cljs$core$IFn$_invoke$arity$1(m);
if(cljs.core.truth_(temp__4126__auto___6819)){
var message_6820 = temp__4126__auto___6819;
cljs.core.println.call(null,message_6820);
} else {
}
...
var temp__4126__auto___6821 = new cljs.core.Keyword(null,"message","message",-406056002).cljs$core$IFn$_invoke$arity$1(m);
if(cljs.core.truth_(temp__4126__auto___6821)){
var message_6822 = temp__4126__auto___6821;
cljs.core.println.call(null,message_6822);
} else {
}
...
var temp__4124__auto__ = (function (){var and__3939__auto__ = typeof exception.stack === 'string';
if(and__3939__auto__){
var G__6828 = exception.stack;
var G__6828__$1 = (((G__6828 == null))?null:clojure.string.split_lines.call(null,G__6828));
var G__6828__$2 = (((G__6828__$1 == null))?null:cljs.core.get.call(null,G__6828__$1,depth));
var G__6828__$3 = (((G__6828__$2 == null))?null:clojure.string.trim.call(null,G__6828__$2));
return G__6828__$3;
} else {
...
var vec__6829 = cljs.test.js_line_and_column.call(null,stack_element);
var line = cljs.core.nth.call(null,vec__6829,(0),null);
var column = cljs.core.nth.call(null,vec__6829,(1),null);
var vec__6830 = cljs.test.mapped_line_and_column.call(null,fname,line,column);
var fname__$1 = cljs.core.nth.call(null,vec__6830,(0),null);
var line__$1 = cljs.core.nth.call(null,vec__6830,(1),null);
var column__$1 = cljs.core.nth.call(null,vec__6830,(2),null);
...
var m__$1 = (function (){var G__6832 = (((new cljs.core.Keyword(null,"type","type",1174270348).cljs$core$IFn$_invoke$arity$1(m) instanceof cljs.core.Keyword))?new cljs.core.Keyword(null,"type","type",1174270348).cljs$core$IFn$_invoke$arity$1(m).fqn:null);
switch (G__6832) {
case "error":
 ...
 * testing.
 */
cljs.test.IAsyncTest = (function (){var obj6835 = {};
return obj6835;
})();
...
var G__6837 = x;
if(G__6837){
var bit__4625__auto__ = null;
if(cljs.core.truth_((function (){var or__3951__auto__ = bit__4625__auto__;
if(cljs.core.truth_(or__3951__auto__)){
return or__3951__auto__;
} else {
return G__6837.cljs$test$IAsyncTest$;
}
})())){
return true;
} else {
if((!G__6837.cljs$lang$protocol_mask$partition$)){
return cljs.core.native_satisfies_QMARK_.call(null,cljs.test.IAsyncTest,G__6837);
} else {
return false;
}
}
...
var G__6840 = (function (){var G__6839 = cljs.core.rest.call(null,fns);
var G__6839__$1 = (cljs.core.truth_(new cljs.core.Keyword("cljs.test","block?","cljs.test/block?",686379965).cljs$core$IFn$_invoke$arity$1(cljs.core.meta.call(null,obj)))?cljs.core.concat.call(null,obj,G__6839):G__6839);
return G__6839__$1;
})();
fns = G__6840;
continue;
...
var G__6842 = fns;
var G__6842__$1 = (((G__6842 == null))?null:cljs.core.vary_meta.call(null,G__6842,cljs.core.assoc,new cljs.core.Keyword("cljs.test","block?","cljs.test/block?",686379965),true));
return G__6842__$1;
});
/**
...
var vec__6846 = fixtures_types.call(null);
var type = cljs.core.nth.call(null,vec__6846,(0),null);
var types = vec__6846;
...
return cljs.core.map.call(null,(function (p__6854){
var vec__6855 = p__6854;
var ns = cljs.core.nth.call(null,vec__6855,(0),null);
var vars__$1 = cljs.core.nth.call(null,vec__6855,(1),null);
return ((function (vec__6855,ns,vars__$1){
return (function (){
...
var G__6856 = (((cljs.test.execution_strategy.call(null,once_fixtures,each_fixtures) instanceof cljs.core.Keyword))?cljs.test.execution_strategy.call(null,once_fixtures,each_fixtures).fqn:null);
switch (G__6856) {
case "sync":
var each_fixture_fn = cljs.test.join_fixtures.call(null,each_fixtures);
return new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [((function (each_fixture_fn,G__6856,env,once_fixtures,each_fixtures,vec__6855,ns,vars__$1){
return (function (){
return cljs.test.join_fixtures.call(null,once_fixtures).call(null,((function (each_fixture_fn,G__6856,env,once_fixtures,each_fixtures,vec__6855,ns,vars__$1){
return (function (){
var seq__6857 = cljs.core.seq.call(null,vars__$1);
var chunk__6858 = null;
var count__6859 = (0);
var i__6860 = (0);
while(true){
if((i__6860 < count__6859)){
var v = cljs.core._nth.call(null,chunk__6858,i__6860);
...
each_fixture_fn.call(null,((function (seq__6857,chunk__6858,count__6859,i__6860,v,each_fixture_fn,G__6856,env,once_fixtures,each_fixtures,vec__6855,ns,vars__$1){
return (function (){
return cljs.test.test_var.call(null,v);
});})(seq__6857,chunk__6858,count__6859,i__6860,v,each_fixture_fn,G__6856,env,once_fixtures,each_fixtures,vec__6855,ns,vars__$1))
);
} else {
}

var G__6862 = seq__6857;
var G__6863 = chunk__6858;
var G__6864 = count__6859;
var G__6865 = (i__6860 + (1));
seq__6857 = G__6862;
chunk__6858 = G__6863;
count__6859 = G__6864;
i__6860 = G__6865;
...
var temp__4126__auto__ = cljs.core.seq.call(null,seq__6857);
if(temp__4126__auto__){
var seq__6857__$1 = temp__4126__auto__;
if(cljs.core.chunked_seq_QMARK_.call(null,seq__6857__$1)){
var c__4736__auto__ = cljs.core.chunk_first.call(null,seq__6857__$1);
var G__6866 = cljs.core.chunk_rest.call(null,seq__6857__$1);
var G__6867 = c__4736__auto__;
var G__6868 = cljs.core.count.call(null,c__4736__auto__);
var G__6869 = (0);
seq__6857 = G__6866;
chunk__6858 = G__6867;
count__6859 = G__6868;
...
var v = cljs.core.first.call(null,seq__6857__$1);
if(cljs.core.truth_(new cljs.core.Keyword(null,"test","test",577538877).cljs$core$IFn$_invoke$arity$1(cljs.core.meta.call(null,v)))){
each_fixture_fn.call(null,((function (seq__6857,chunk__6858,count__6859,i__6860,v,seq__6857__$1,temp__4126__auto__,each_fixture_fn,G__6856,env,once_fixtures,each_fixtures,vec__6855,ns,vars__$1){
return (function (){
return cljs.test.test_var.call(null,v);
});})(seq__6857,chunk__6858,count__6859,i__6860,v,seq__6857__$1,temp__4126__auto__,each_fixture_fn,G__6856,env,once_fixtures,each_fixtures,vec__6855,ns,vars__$1))
);
} else {
}

var G__6870 = cljs.core.next.call(null,seq__6857__$1);
var G__6871 = null;
var G__6872 = (0);
var G__6873 = (0);
seq__6857 = G__6870;
...
});})(each_fixture_fn,G__6856,env,once_fixtures,each_fixtures,vec__6855,ns,vars__$1))
);
});})(each_fixture_fn,G__6856,env,once_fixtures,each_fixtures,vec__6855,ns,vars__$1))
], null);
