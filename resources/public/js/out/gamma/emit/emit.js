...
var or__3951__auto__ = new cljs.core.PersistentHashSet(null, new cljs.core.PersistentArrayMap(null, 2, [true,null,false,null], null), null).call(null,x);
...
gamma.emit.emit.emit = (function (){var method_table__4846__auto__ = cljs.core.atom.call(null,cljs.core.PersistentArrayMap.EMPTY);
...
return (new cljs.core.MultiFn(cljs.core.symbol.call(null,"gamma.emit.emit","emit"),gamma.emit.emit.emit_dispatch,new cljs.core.Keyword(null,"default","default",-1987822328),hierarchy__4850__auto__,method_table__4846__auto__,prefer_table__4847__auto__,method_cache__4848__auto__,cached_hierarchy__4849__auto__));
})();
}
