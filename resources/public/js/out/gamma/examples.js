...
gamma.examples.gcompile = (function gamma$examples$gcompile(input){
...
gamma.examples.show_ast = (function gamma$examples$show_ast(y){
...
gamma.examples.show = (function gamma$examples$show(x){
...
gamma.examples.shader_str = (function gamma$examples$shader_str(x){
var sb__4907__auto__ = (new goog.string.StringBuffer());
var _STAR_print_newline_STAR_6089_6091 = cljs.core._STAR_print_newline_STAR_;
var _STAR_print_fn_STAR_6090_6092 = cljs.core._STAR_print_fn_STAR_;
cljs.core._STAR_print_newline_STAR_ = true;

cljs.core._STAR_print_fn_STAR_ = ((function (_STAR_print_newline_STAR_6089_6091,_STAR_print_fn_STAR_6090_6092,sb__4907__auto__){
return (function (x__4908__auto__){
return sb__4907__auto__.append(x__4908__auto__);
});})(_STAR_print_newline_STAR_6089_6091,_STAR_print_fn_STAR_6090_6092,sb__4907__auto__))
;

try{gamma.examples.show.call(null,x);
}finally {cljs.core._STAR_print_fn_STAR_ = _STAR_print_fn_STAR_6090_6092;

cljs.core._STAR_print_newline_STAR_ = _STAR_print_newline_STAR_6089_6091;
}
return [cljs.core.str(sb__4907__auto__)].join('');
});
gamma.examples.walk = (function gamma$examples$walk(db,pre){
return gamma.compiler.core.transform.call(null,db,(function gamma$examples$walk_$_walk_fn(db__$1,path){
return new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [pre.call(null,db__$1,path),new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"body","body",-2049205669),gamma.compiler.common.map_path.call(null,gamma$examples$walk_$_walk_fn)], null)], null)], null);
}));
});
gamma.examples.variables = (function gamma$examples$variables(db){
...
var e_6093 = gamma.compiler.common.get_element.call(null,db__$1,location);
if(cljs.core._EQ_.call(null,new cljs.core.Keyword(null,"literal","literal",1664775605),new cljs.core.Keyword(null,"head","head",-771383919).cljs$core$IFn$_invoke$arity$1(e_6093))){
if(cljs.core._EQ_.call(null,new cljs.core.Keyword(null,"variable","variable",-281346492),new cljs.core.Keyword(null,"tag","tag",-1290361223).cljs$core$IFn$_invoke$arity$1(new cljs.core.Keyword(null,"value","value",305978217).cljs$core$IFn$_invoke$arity$1(e_6093)))){
cljs.core.swap_BANG_.call(null,a,cljs.core.conj,new cljs.core.Keyword(null,"value","value",305978217).cljs$core$IFn$_invoke$arity$1(e_6093));

if(cljs.core.truth_(new cljs.core.Keyword(null,"type","type",1174270348).cljs$core$IFn$_invoke$arity$1(new cljs.core.Keyword(null,"value","value",305978217).cljs$core$IFn$_invoke$arity$1(e_6093)))){
} else {
...
gamma.examples.program = (function gamma$examples$program(db){
...
gamma.examples.emit_program = (function gamma$examples$emit_program(db){
